...
# [cite: 90-93]
POSITIVE_WORDS = {"good", "great", "excellent", "happy", "love", "wonderful", "best", "amazing", "fantastic", "superb"}
NEGATIVE_WORDS = {"bad", "terrible", "horrible", "hate", "worst", "awful", "poor", "dreadful", "disgusting"}
_last_confidence = 0.95

@app.route("/health", methods=["GET"])
def health():
    return jsonify({"status": "healthy", "model": "rule-based-stable-v0", "model_version": "stable-v0-1E00"})
...
def predict():
    ...
    return jsonify({"label": label, "confidence": confidence, "model_version": "stable-v0-1E00"})
